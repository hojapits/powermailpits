 ...
 * @version
 */
class CountryPrefillFieldViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
	...
	protected function getDefaultValue(
		...
		// POWERMAIL PITS CONFIGURATION OVER-RIDE HERE :)
		elseif ( is_array( $this->getCountryPrefill( $uid ) )) {
			$result = $this->getCountryPrefill( $uid );
			$value 	= $result['tx_powermailextended_powermail_text'];
		}
	...
	/**
	 * Get Powermail PITS Country Select Prefill
	 *
	 * @return void
	 */
	public function getCountryPrefill( $uid ) {
		$selectFields		=	" uid ,tx_powermailextended_powermail_text";
